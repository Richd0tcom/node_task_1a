...
module.exports = function (entity, pageName, success, error, baseUrl) {
  ...
  this._list = [];
  this._column = ["ID", "Message", "Counter","Action"];
  ...
  this.set_counter = function (counter) {
  ...
  this.to_json = function () {
    ...
    for (let key in list) {
      ...
      clean_list_entry["message"] = value["message"];
      clean_list_entry["counter"] = value["counter"];
